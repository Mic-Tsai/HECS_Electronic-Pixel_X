...
//************************************************************
//************************************************************
#define CURRENT_MAX   1000   //Brightness-setting(500-1800) Max current from power supply (mA)
//************************************************************
//************************************************************
...
//************************************************************
  ...
  startupTrigger = LOW; // Set LOW go direct to transfer bmp image process
                        // Set HIGH  --> Skip
